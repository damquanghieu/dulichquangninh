...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- /.col-lg-12 -->
            <form action="{{route('post.edit.role',['id'=>$findRole->id])}}" method="POST">
                <div class="row">
                    <div class="col-md-12" style="padding-bottom:40px">
                        {!!csrf_field() !!}
                        <div class="form-group">
                            <label>Tên vai trò: </label>
                            <input class="form-control" name="name" value="{{$findRole->name}}" />
                        </div>
                        <div class="form-group">
                            <label>Miêu tả vai trò: </label>
                            <input type="text" class="form-control" name="description"
                                value="{{$findRole->description}}" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row role_module">
                            ...
                            <div class="content-module col-md-3">
                                <label><input {{$findRole->permissions->contains('id',$child->id)? 'checked':''}} class="checkbox" type="checkbox" name="permissions[]"value="{{$child->id}}">{{$child->display_name}}</label>
                            </div>
                            @endforeach
                        </div>
                        @endforeach
