...
<head>
    ...
    <meta name="description" content="Du lịch Quảng Ninh">
    <meta name="author" content="">
    <title>Admin -Đàm Hiếu</title>
    ...
    <!-- Custom Fonts -->
    <link href="{{asset('admin1/bower_components/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet"
        type="text/css">

    <!-- DataTables CSS -->
    <link
        href="{{asset('admin1/bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.css')}}"
        rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="{{asset('admin1/bower_components/datatables-responsive/css/dataTables.responsive.css')}}"
        rel="stylesheet">
